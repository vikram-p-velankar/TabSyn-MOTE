...
sys.path.append('/Users/vikramvelankar/Downloads/TableDiffusion-master/tablediffusion/config')
...
def load_and_prep_data(dataset="diabetes", datadir="/Users/vikramvelankar/Downloads", verbose=False):
